...
class GraspGroup():
    ...
    def to_open3d_geometry_list(self, color=None):
        ...
        **Output:**
        ...
        for i in range(len(self.grasp_group_array)):
            ...
            geometry.append(g.to_open3d_geometry(color=color))
        return geometry
    ...
    def to_rect_grasp_group(self, camera, perpendicular_ratio=0.99):
        '''
        **Input:**

        - camera: string of type of camera, 'realsense' or 'kinect'.
        - perpendicular_ratio: float of how the grasps are vertical to the view plane.
        ...
        **Output:**
        ...
        mask = (rotations[:, 2, 0] > perpendicular_ratio)
